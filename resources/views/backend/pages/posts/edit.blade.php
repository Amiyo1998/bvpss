                ...
                <div class="mx-2">
                    <form action="{{ route('posts.update', $post->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row border border-3 ">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control-plaintext @error('title') is-invalid @enderror " name="title" id="title" value="{{ $post->title}}">
                            @error('title')
                        ...
                        <div class="form-group row border border-3 ">
                            ...
                            <div class="col-sm-9">
                                <select name="cat_id" id="cat_id" class="form-control-plaintext ">
                                    <option value="{{ $post->cat_id}}" class="@error('cat_id') is-invalid @enderror ">{{ $post->category->name}}</option>
                                </select>
                              @error('cat_id')
                                  <strong class="text-danger">{{ $message }}</strong>
                              @enderror
                          ...
                          <div class="form-group row border border-3 ">
                            ...
                            <div class="col-sm-9">
                                <textarea name="body" id="body" cols="20" rows="5" class="form-control-plaintext @error('body') is-invalid @enderror ">{{ $post->body}}</textarea>
                              @error('body')
                                  <strong class="text-danger">{{ $message }}</strong>
                              @enderror
                            </div>
                          ...
                          <div class="form-group row border border-3 ">
                            ...
                            <div class="col-sm-9">
                              ...
                              <img src="{{ asset('storage/'.$post->image)}}" alt="" width="80px" height="50px"></td>
                              @error('image')
                                  <strong class="text-danger">{{ $message }}</strong>
                              @enderror
                            </div>
